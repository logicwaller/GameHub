<template>
  <section class="hero">
    <div class="hero-copy"><p class="eyebrow">GAME DISCOVERY PLATFORM</p><h1>找到你的<br><em>下一场冒险</em></h1><p class="lead">精选网页游戏，随时打开即玩。探索不同世界，收藏属于你的游戏清单。</p><div class="hero-actions"><RouterLink class="primary" to="/games">开始探索 <span>→</span></RouterLink><RouterLink class="secondary" to="/games">浏览全部游戏</RouterLink></div></div>
