<template>
  <section class="hero">
    <div class="hero-copy">
      ...
      <div class="hero-actions">
        <RouterLink class="primary" to="/games">开始探索 <span>→</span></RouterLink>
        <RouterLink class="secondary" to="/games">浏览全部游戏</RouterLink>
      </div>
    </div>
    <div class="hero-art">
      ...
      <div class="art-label">CURATED<br><strong>PLAYLIST</strong></div>
    </div>
  </section>
  ...
  <section class="section">
    <div class="section-head">
      ...
      <RouterLink to="/games" class="view-all">查看全部 <span>→</span></RouterLink>
    </div>
    <div class="game-grid">
      <RouterLink
      ...
      >
        ...
        <div class="game-info">
          ...
          <div>
            ...
            <span class="play-count">{{ format(game.plays) }} 次游玩</span>
          </div>
        </div>
      </RouterLink>
    </div>
